...
class TotalHandlers(WriteHandlerBase):
    ...
    def handle_total_amount_usd_english(self, cell: Cell) -> CellparseResult:
        ...
        self._worksheet.row_dimensions[cell.row + 2].height = 30
        self._worksheet.cell(cell.row + 2, cell.column).value = self._datasource.get_data_source(CI00ReadParseResult)["total_amount_english"]
        return CellparseResult()
